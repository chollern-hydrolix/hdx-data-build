...
with salesforce_leads as (
    select
        ...
        l.entered_initial_engagement__c as entered_initial_engagement,
        l.entered_qualifying_mnda__c as entered_qualifying,
        l.entered_alignment_to_business__c as entered_alignment_to_business,
        l.entered_validation_with_customer__c as entered_validation_with_customer,

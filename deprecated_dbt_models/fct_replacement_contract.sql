...
with contract_links as (
    ...
    from salesforce.contract cont
    left join salesforce.contract prev_cont on cont.previous_contract__c = prev_cont.id
    left join salesforce.account acct on cont.account_id = acct.id
